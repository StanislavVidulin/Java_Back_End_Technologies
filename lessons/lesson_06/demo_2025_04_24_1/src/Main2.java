...
//            if (lock.tryLock()) // единомоментная (мгновенная) попытка захватить ресурс
            // Без таймаута не успеваем захватить ресурс, с таймаутом за эти 3 секунды ресурс
            // освобождается и мы входим в if и захватываем ресурс
            try {
